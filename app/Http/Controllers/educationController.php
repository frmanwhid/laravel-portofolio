...
class educationController extends Controller
{
    ...
    {
        $data = riwayat::where('tipe', $this->_tipe)->orderBy('tgl_akhir'
    , 'desc')->get();
    ...
    public function store(Request $request)
    {
        ...
        [
            ...
            'info1.required' => 'Nama Univeristas wajib diisi',
        ...
        ('success', 'berhasil menambahkan data education');
    }
    ...
    public function update(Request $request, string $id)
    {
        $request->validate(
            ...
            return redirect()->route('education.index')->with
            ('success', 'Berhasil melakukan update data education');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('education.index')->with
        ('success', 'Berhasil melakukan delete data education');
    }
}
