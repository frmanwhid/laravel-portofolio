...
@section('konten')
    ...
    <form action="{{ route('education.store') }}" method="POST">
        @csrf
        <div class="mb-3">
            <label for="judul" class="form-label">Univeritas</label>
            <input
                type="text"
        ...
        <div class="mb-3">
            <label for="judul" class="form-label">Nama Fakultas</label>
            <input
                type="text"
                class="form-control form-control-sm"
                name="info1"
        ...
        <div class="mb-3">
            <label for="judul" class="form-label">Nama Prodi</label>
            <input
                type="text"
                class="form-control form-control-sm"
                name="info2"
        ...
        <div class="mb-3">
            <label for="judul" class="form-label">IPK</label>
            <input
                type="text"
                class="form-control form-control-sm"
                name="info3"
